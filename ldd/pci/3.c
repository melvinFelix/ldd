...
/*
 * The code herein is: ITRONIX SOLUTION
 *
 * This Copyright is retained for the purpose of protecting free
 * redistribution of source.
 *
 *     URL:    http://www.itronixsolution.com
 *     email:  info@itronixsolution.com
 *
 * The primary maintainer for this code is Er. Karan Arora
...
static int __init my_init(void)
{
	...
	dev = alloc_netdev(0, "MYWIFI%d", my_setup);
